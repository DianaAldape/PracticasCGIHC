...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(mainWindow.getcodo()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));

		//antebrazo
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getcodo() * toRadians), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//palma
		//model = glm::mat4(1.0);
		model = glm::rotate(model, glm::radians(mainWindow.getmuneca() ), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//Rotación Saludo de Spock 
		// model = glm::rotate(model, glm::radians(15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		//Rotación  V de victoria
		//model = glm::rotate(model, glm::radians(15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		////Rotación  V de victoria y viva Rock
		model = glm::rotate(model, glm::radians(-65.0f), glm::vec3(1.0f, 0.0f, 0.0f));


		//falange dedo 5
		model = glm::translate(model, glm::vec3(0.0f, 0.30, 0.0f));
	
		matrizaux = model;
		model = glm::scale(model, glm::vec3(0.09f, 0.30f, 0.2f));
		...
		//articulacion-falange-falangina
		model = matrizaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.26, 0.0f));
		...
		matrizaux = model;
		model = glm::scale(model, glm::vec3(0.09f, 0.50f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));

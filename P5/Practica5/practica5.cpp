...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
	   ...
	   //----------Termina dedo Índice--------------
		...
		//falange dedo Anular
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalange_2() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
		matrizaux = model;
		...
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalangina_2() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalangeta_2() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.09f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		...
		//falange dedo Anular
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalange_3() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
		matrizaux = model;
		model = glm::scale(model, glm::vec3(0.3f, 0.1f, 0.2f));
		...
		//falangina dedo Anular
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalangina_3() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = matrizaux;
		model = glm::translate(model, glm::vec3(0.125f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getfalangeta_3()),
			glm::vec3(0.0f, -1.0f, 0.0f));
		//falangeta dedo Anular
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalangeta_3() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.08f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		...
		//falange dedo Anular
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalange_4() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		...
		//falangina dedo Anular
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalangina_4() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
		matrizaux = model;
		model = glm::scale(model, glm::vec3(0.3f, 0.08f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = matrizaux;
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getfalangeta_4()),
			glm::vec3(0.0f, -1.0f, 0.0f));
		//falangeta dedo Anular
		//model = glm::mat4(1.0);
		//model = glm::rotate(model, glm::radians(mainWindow.getfalangeta_4() * toRadians), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
